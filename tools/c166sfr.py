...
SFR = [
    ...
    # ZEROS и ONES -- постоянные источники нулей и единиц. Найдены не по
    # описанию архитектуры, а по коду: mov 0xf8a0, 0xff1c оказалось
    # обнулением расхода воздуха, и без этой строки в карте смысл был бы
    # потерян.
    ("ZEROS", 0xFF1C, "система", "константа: все биты нули"),
    ("ONES", 0xFF1E, "система", "константа: все биты единицы"),
