...
def main():
    ...
    # общим порогом.
    # Пара KFBAKL + KRKTE отсюда УШЛА, и не порогом: KRKTE стоял на 0x19485
    # по выравниванию, а код читает 0x1955A. Настоящий адрес перекрытия не
    # даёт. Это и был тот случай, о котором говорилось выше -- «две
    # подтверждённые на одних байтах означают, что неверна одна из них».
    KNOWN = {
